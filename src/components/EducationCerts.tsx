...
export const EducationCerts: React.FC = () => {
  return (
    <section className="py-14 sm:py-20 border-t border-paper-200 dark:border-paper-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-2 mb-10">
          ...
          <p className="text-paper-600 dark:text-paper-400 text-sm sm:text-base max-w-2xl leading-relaxed">
            Formal Computer Science degree paired with industry-recognized cloud, API, and web development certifications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono text-paper-500 dark:text-paper-400">Engineering Degree</p>
                </div>
              </div>
            ...
            <div className="mt-6 pt-4 border-t border-paper-100 dark:border-paper-800 text-[11px] font-mono text-paper-500 dark:text-paper-400">
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono text-paper-500 dark:text-paper-400">Industry Validated</p>
                </div>
              </div>
            ...
            <div className="mt-6 pt-4 border-t border-paper-100 dark:border-paper-800 text-[11px] font-mono text-paper-500 dark:text-paper-400">
              Actively pursuing advanced AWS &amp; Spring Enterprise certifications.
            </div>
          </motion.div>
